odoo.define('product_configurator_customfrom.product_configurator_customfrom', function (require) {
    ...
    _handleAdd: function () {
        ...
        this.renderer.selectOrCreateProduct(
            ...
            self.rootProduct = {
                ...
                coif_total: parseFloat($modal.find('input[name="coif_total"]').val() || 0),
